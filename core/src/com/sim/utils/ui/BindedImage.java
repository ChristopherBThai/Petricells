...
public class BindedImage extends Image implements Binded{
	...
	public BindedImage(Sprite sprite, float width, float height, float xPercent, float yPercent) {
	...
	public BindedImage(Sprite sprite, float width, float height) {
		super(sprite, width, height);
		origionalWidth = width;
		origionalHeight = height;
	}

	public BindedImage(Sprite sprite) {
		super(sprite);
		origionalWidth = sprite.getWidth();
		origionalHeight = sprite.getHeight();
	}
